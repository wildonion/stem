...
/*
    ...
    concepts:
        shared ownership:
            - single thread: Rc, Weak, RefCell 
            - multi thread : Arc and Mutex
        Arc is Rc and Mutex is RefCell
        parent node to children is Arc or Rc 
        children to parent node is RefCell<Rc<Vec<Node>>> or Mutex<Vec<Arc<Node>>>
